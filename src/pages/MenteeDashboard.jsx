    ...
    <div className="flex flex-col h-screen bg-[--bg-black-900] text-[--text-black-900]">
      ...
      <header className="bg-[--bg-black-100] shadow-md p-4">
        <div className="container mx-auto flex justify-center items-center">
          <h1 className="text-xl font-semibold">Mentee Dashboard</h1>
          ...
          <div className="p-4 h-full flex flex-col">
              ...
              <ul className="space-y-2">
                <li>
                  ...
                  >
                    ...
                    <span className="ml-3">BookAppointment</span>
                  </button>
                </li>
                <li>
                  <button
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="ml-3">Feedback & Notes</span>
                  </button>
                </li>
              </ul>
            </nav>
            ...
            <div className="mt-auto p-4 bg-[--bg-black-50] rounded-lg flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-[--text-black-700]">Mentee</p>
              </div>
            </div>
          </div>
        </div>
